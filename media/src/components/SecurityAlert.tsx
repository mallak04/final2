  ...
  return (
    <>
      <motion.div
        ...
        className="bg-red-500 border-2 border-red-600 rounded-lg px-4 py-3 mb-4 shadow-lg"
      >
        <div className="flex items-center justify-between">
          ...
          <motion.button
            ...
            className="ml-4 px-3 py-1.5 bg-white text-red-600 rounded-md text-xs font-semibold hover:bg-red-50 transition-colors flex-shrink-0"
          >
            Learn more
          </motion.button>
        </div>
        ...
        {showModal && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-2xl border border-gray-200 w-full max-w-2xl z-50 max-h-[90vh] overflow-y-auto"
            >
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Never Hardcode Credentials</h4>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Protect User Privacy</h4>
                      <p className="text-sm text-gray-600 mb-2">
                  ...
                  <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Use .gitignore Properly</h4>
                      <p className="text-sm text-gray-600 mb-2">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-lg border border-blue-200">
                  <h4 className="font-semibold text-gray-900 mb-2">Quick Fix Checklist</h4>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => setShowModal(false)}
                  className="w-full py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-lg hover:shadow-lg transition-shadow"
                >
                  I Understand
                </motion.button>
              </div>
